...
\begin{frame}{Algorithm Partitioning}
	\begin{itemize}
		...
		\item Since PL operates at \eqn{100} MHz, we require \gretxt{parallel SVD operations to increase throughput}
		\item With the available resources, only \blutxt{\eqn{5} SVD operations can be performed in parallel} due to \redtxt{limited availability of DSP48 units}
